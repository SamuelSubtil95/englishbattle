	...
	<section style="background-color: ghostwhite; height: 100vh"
		...
		<div
			...
			<section class=" col-md-8 col-8 col-xl-8">
				<form enctype='multipart/form-data' method="POST" action="inscriptiontele">
					...
					<br>
					<div class="mb-3">
						<label for="formFile" class="form-label">Photo de profil</label> <input name="PHOTO" class="form-control" type="file"
							id="formFile">
					</div>
					<br>
